...
#include "Packages/tsukuyomi.render-pipelines.universal/ShaderLibrary/VolumetricShadows.hlsl"
#include "Packages/tsukuyomi.render-pipelines.universal/ShaderLibrary/ShaderVariablesVolumetricFog.hlsl"
//#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/PrecomputeRadianceTransfer/EvaluateProbeVolume.hlsl"
...
half4 VolumetricFog(float2 uv, float2 positionCS) // positionCS is actually positionSS when using ComputeShader.
{
    ...
    for (int i = 0; i < _MaxSteps; ++i)
    {
        ...
        half3 stepColor = mainLightColor;
