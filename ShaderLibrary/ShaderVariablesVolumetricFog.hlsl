...
#define VOLUMETRIC_VARIABLES_INCLUDED
    ...
    #define RW_TEXTURE2D_X(type, name) RWTexture2DArray<type> name
    #define COORD_TEXTURE2D_X(coord) uint3(coord, SLICE_ARRAY_INDEX)
#else
    #define RW_TEXTURE2D_X(type, name) RWTexture2D<type> name
    #define COORD_TEXTURE2D_X(coord) coord
#endif
